...
int main() {
    ...
    string start_street_query = "\x42\x61\x6C\x7A\x61\x63\x20\x75\x74\x63\x61"; // "Balzac utca"
    string end_street_query = "\x46\x61\x64\x72\x75\x73\x7A\x20\x75\x74\x63\x61";     // "Fadrusz utca"
